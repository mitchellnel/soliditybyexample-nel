...
// We have to list the parent contracts in the order from "most base-like" to "most derived
// (i.e. ancestor to child)
...
// When a function is called that is defined multiple times in different contracts, parent
// contracts are searched from right to left, and in a depth-first manner
